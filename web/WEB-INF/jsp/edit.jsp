<%@ page import="application.model.ContactType" %>
<%@ page import="application.model.ListSection" %>
<%@ page import="application.model.OrganizationSection" %>
<%@ page import="application.model.SectionType" %>
<%@ page import="application.util.DateUtil" %>
                    ...
                    <c:forEach var="org" items="<%=((OrganizationSection) section).getOrganizations()%>"
                        ...
                        <div style="margin-left: 30px">
                            <c:forEach var="pos" items="${org.positions}">
                                <jsp:useBean id="pos" type="application.model.Organization.Position"/>
                                <dl>
